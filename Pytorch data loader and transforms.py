...
print(summary(resnet50, (3, 227, 227))) #22
...
exp_lr_scheduler = lr_scheduler.StepLR(optimizer, step_size=3, gamma=0.1) #23
...
idx_to_class = {0:'Negative', 1:'Positive'} #24
        ...
        for i, (inputs, labels) in enumerate(dataloaders['val']):
            ...
            for j in range(inputs.size()[0]):
                ...
                if images_handeled == num_images:
                    ...
                    return
        model.train(mode=was_training) #26
